...
\author{
  ...
  \includegraphics[height=0.3cm]{_static/author_email.png}
}
\date \today
...
(now and in the future).
  ...
  %
  %\textit{(Although optimized for LAMMPS, moltemplate is a general text manipulation tool which, in principle, could be used to generate topology and force-field files for other simulation programs.  Please email \includegraphics[height=0.3cm]{_static/author_email.png} if you want to attempt this.)}
  %
...
(This is usually something like \textapprox/.local/bin/ or
\textapprox/anaconda3/bin/.  If you have installed anaconda, your PATH
...
to your home directory (\textapprox/) and run:
\begin{verbatim}
cd  ~/moltemplate
...
(eg. ``\textapprox/moltemplate/moltemplate/scripts/''), as well as
the directory containing the most of the python scripts
(eg. ``\textapprox/moltemplate/moltemplate/'').
...
\begin{figure}[htbp]
\centering
\includegraphics[width=2.4cm]{_static/single_water_LR.jpg}
\caption{
...
\centering
\textbf{a)}
\includegraphics[width=5cm]{_static/waterSPCEx1000_LR.jpg}
\textbf{b)}
\includegraphics[width=5cm]{_static/waterSPCEx1000_t=25_LR.jpg}
\caption{
...
\centering
\textbf{a)}
\includegraphics[height=3cm]{_static/2bead_monomer.jpg}
\quad \quad \quad \quad \quad
\textbf{b)}
\includegraphics[height=3cm]{_static/2bead_polymer.jpg}
\newline
\vspace{10 mm}
\newline
\textbf{c)}
\includegraphics[width=4cm]{_static/2bead_polymers_nopbc_t=0_LR.jpg}
\textbf{d)}
\includegraphics[width=4cm]{_static/2bead_polymers_t=100ps_LR.jpg}
\caption{
...
\centering
\textbf{a)}
\includegraphics[height=1.2cm]{_static/random_2bead.jpg}
\hspace{0.2cm}
\textbf{b)}
\includegraphics[height=0.75cm]{_static/random_3bead.jpg}
\hspace{0.2cm}
\textbf{c)}
\includegraphics[width=8cm]{_static/random_heteropolymer.jpg}
%\newline
%\vspace{10 mm}
%\newline
\caption{
...
\centering
\textbf{a)}
\includegraphics[width=5cm]{_static/lipid_bilayer_mixture.jpg}
\hspace{0.5cm}
\textbf{b)}
\includegraphics[width=5cm]{_static/lipid_bilayer_vacancies.jpg}
%\newline
%\vspace{10 mm}
%\newline
\caption{
...
\begin{figure}[htbp]
\centering
\includegraphics[width=4.0cm]{_static/delete_holes1.jpg}
\caption{
...
\centering
\textbf{a)}
\includegraphics[height=3cm]{_static/mol_complex_LR.jpg}
\hspace{1cm}
\textbf{b)}
\includegraphics[height=3cm]{_static/mol_complex+mol_complex0_transparent_LR.jpg}
%\newline
%\vspace{10 mm}
%\newline
\caption{
...
Again, feel free to contact \includegraphics[height=0.3cm]{_static/author_email.png}
...
supported.
Feel free to contact \includegraphics[height=0.3cm]{_static/author_email.png}
...
@atom, @bond, @angle, @dihedral,} and \textit{@improper}.)
  ...
  %contact \includegraphics[height=0.3cm]{_static/author_email.png} 
